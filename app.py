...
# API配置
API_KEY = os.environ.get("API_KEY", "ExampleAPIKey")
API_URL = os.environ.get("API_URL", "http://example.com/api")
# 模型列表
# 这里的模型名称和ID需要根据实际API进行调整
MODELS = {
    "GLM4-Flash": "GLM-4-FlashX-P002",
    "deepseek-r1": "DeepSeek-R1",
    "deepseek-v3": "DeepSeek-V3-250324-P001"
}
...
def call_llm_api(prompt, model_name, image_base64=None):
    ...
    try:
        response = requests.post(f"{API_URL}/v1/chat/completions", headers=headers, json=payload, stream=False)
